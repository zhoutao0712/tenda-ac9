...
function show_banner(L3){// L3 = The third Level of Menu
	...
	if (spirit_logo_support)
		...
		banner_code +='<div style="margin-top:13px;margin-left:128px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top">ZHTEL RT-AC1200G+</span></div>';
	}
...
tabtitle[6] = new Array("", "<#BOP_isp_heart_item#>", "<#vpnc_title#>", "TOR", "TINC");
...
// Level 2 Menu
menuL2_title = new Array("", "<#menu5_1#>", "Passpoint", "<#menu5_2#>", "<#menu5_3#>", "<#menu5_4#>", "IPv6", "GFW-VPN", "<#menu5_5#>", "<#menu5_6#>", "<#System_Log#>", "<#Network_Tools#>");
