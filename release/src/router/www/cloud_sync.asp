...
function dropbox_login(){
	...
	var redirect_url = "https://oauth.zhtel.com/aicloud/dropbox.html";			
	...
	//Then Dropbox will encode the url twice, the char = will become %3D, and callback oauth.zhtel.com will cause url not correct.
