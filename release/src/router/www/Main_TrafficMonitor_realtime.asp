...
function init()
{
	...
	ref.start();
	document.getElementById("faq0").href = "http://www.zhtel.com"+ href_lang +"support/Search-Result-Detail/69B50762-C9C0-15F1-A5B8-C7B652F50ACF/?keyword=ASUSWRT%20Traffic%20Monitor" ;
